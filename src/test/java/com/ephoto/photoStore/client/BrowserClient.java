package com.ephoto.photoStore.client;
...
public class BrowserClient {
    ...
    public void clickAddToCart(String title) {
        ...
        HtmlElement addButton = itemCards.get(0).querySelector(".add-to-cart");
        if (addButton == null) {
    ...
    public Integer getCartItems() {
        try {
            String cartTotalValue = this.currentPage.querySelector(".cart-total").asText();
            return Integer.parseInt(cartTotalValue);
    ...
    public void goToCart() {
        this.currentPage = this.webClient.getPage("http://localhost/cart");
    }

    public String getCartItemQtyLabel(String title) {
